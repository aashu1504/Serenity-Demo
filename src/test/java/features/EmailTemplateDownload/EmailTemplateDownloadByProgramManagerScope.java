...
public class EmailTemplateDownloadByProgramManagerScope {
	...
	@Test
	@Issue("SW-6386")
	public void verifyETemplateDownloadFilesWithoutLandingPageFromProgramManager() throws InterruptedException, IOException
	{
		...
		createTemplateEmail.clickSaveEmailTemplate();
		userNavigationSteps.clickonARoleFromListOfRoles("Program Manager");
